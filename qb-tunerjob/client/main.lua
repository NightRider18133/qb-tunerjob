...
local function OpenMenu()
    local OpenMenu = {
        ...
        },
        {
            ...
            params = {
                event = "qb-tunerjob:client:UnattachVehicle",
            }
        },
        {
            header = "Check Status",
            ...
            params = {
                event = "qb-tunerjob:client:CheckStatus",
                args = {
                    number = 1,
                }
            }
        },    
        {
            ...
            params = {
                event = "qb-tunerjob:client:PartsMenu",
                args = {
                    number = 1,
                }
            }
        ...
        for k,v in pairs(Config.ValuesLabels) do
            if math.ceil(VehicleStatus[plate][k]) ~= Config.MaxStatusValues[k] then
                ...
                vehicleMenu[#vehicleMenu+1] = {
                    ...
                    params = {
                        event = "qb-tunerjob:client:PartMenu",
                        args = {
                            name = v,
                            parts = k
                        }
                ...
                vehicleMenu[#vehicleMenu+1] = {
                    ...
                    txt = "Status: " .. percentage .. ".0% / 100.0%",
                    params = {
                        event = "qb-tunerjob:client:NoDamage",
                    }
                }
            end                               
        end
...
local function PartMenu(data)
    ...
    local TestMenu1 = {
        ...
        },
        {
            ...
            params = {
                event = "qb-tunerjob:client:RepairPart",
                args = {
                    part = part,
                }
            }
...
local function VehicleList()
    ...
    for k,v in pairs(Config.Vehicles) do
        vehicleMenu[#vehicleMenu+1] = {
            ...
            txt = "Vehicle: "..v.."",
            params = {
                event = "qb-tunerjob:client:SpawnListVehicle",
                args = {
                    headername = v,
                    spawnName = k
                }
...
-- Events
RegisterNetEvent("qb-tunerjob:client:UnattachVehicle",function(data)
    UnattachVehicle()
end)

RegisterNetEvent("qb-tunerjob:client:PartsMenu",function(data)
    PartsMenu()
end)

RegisterNetEvent("qb-tunerjob:client:PartMenu",function(data)
    PartMenu(data)
end)

RegisterNetEvent("qb-tunerjob:client:NoDamage",function(data)
    NoDamage()
end)

RegisterNetEvent("qb-tunerjob:client:CheckStatus",function(data)
    CheckStatus()
end)

RegisterNetEvent("qb-tunerjob:client:SpawnListVehicle",function(data)
    local vehicleSpawnName=data.spawnName
    SpawnListVehicle(vehicleSpawnName)
end)

RegisterNetEvent("qb-tunerjob:client:RepairPart",function(data)
...
CreateThread(function()
    ...
    AddTextComponentSubstringPlayerName("Tuner Mechanic")
                    ...
                    if StashDistance < 20 then
                        ...
                        if StashDistance < 1 then
                            ...
                            if IsControlJustReleased(0, 38) then
                                TriggerEvent("inventory:client:SetCurrentStash", "tunerstash")
